 ...
 */
const t$1 = window.ShadowRoot && (window.ShadyCSS === void 0 || window.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, e$2 = Symbol(), n$3 = /* @__PURE__ */ new Map();
class s$3 {
  constructor(t2, n2) {
...
class a$1 extends HTMLElement {
  ...
  requestUpdate(t2, i2, s2) {
    let e2 = true;
    t2 !== void 0 && (((s2 = s2 || this.constructor.getPropertyOptions(t2)).hasChanged || n$2)(this[t2], i2) ? (this._$AL.has(t2) || this._$AL.set(t2, i2), s2.reflect === true && this._$Ei !== t2 && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(t2, s2))) : e2 = false), !this.isUpdatePending && e2 && (this._$Ep = this._$E_());
  }
  async _$E_() {
...
class LitBtn extends s {
  constructor() {
    super();
    this.count = 0;
  }
  render() {
    return $`<button @click=${() => this.count++}>Btn ${this.count}</button>`;
  }
}
__publicField(LitBtn, "styles", r$2`
    button {
        color: var(--mycolor);
    }
    `);
__publicField(LitBtn, "properties", {
  count: 0
});
